...
from .views import historique_par_jour_paiement_view, stats_view, jours_cumules_view, historique_view, export_pdf_historique_view
...
urlpatterns = [
    ...
    path('historique-par-jour-paiement/', historique_par_jour_paiement_view, name='dashboard-historique-par-jour'),
